...
Specifically, refer to the script :project_file:`export_onnx.py <models/coco_pose/models/export_onnx.py>` to convert the pre-trained yolo11n-pose model to an ONNX model.
