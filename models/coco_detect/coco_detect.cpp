...
COCODetect::COCODetect(model_type_t model_type, bool lazy_load) : m_model_type(model_type)
{
    ...
    case model_type_t::YOLO11N_320_S8_V1:
...
void COCODetect::load_model()
{
    ...
    case model_type_t::YOLO11N_S8_V1:
        ...
        break;
    case model_type_t::YOLO11N_320_S8_V1:
#if CONFIG_FLASH_COCO_DETECT_YOLO11N_320_S8_V1 || CONFIG_COCO_DETECT_MODEL_IN_SDCARD
        m_model = new coco_detect::Yolo11n("coco_detect_yolo11n_320_s8_v1.espdl", m_score_thr[0], m_nms_thr[0]);
#else
        ESP_LOGE("coco_detect", "coco_detect_yolo11n_320_s8_v1 is not selected in menuconfig.");
#endif
        break;
    }
}
