...
|  yolo26n_512_s8_p4_tpie |  512×512×3 |  16 |  32 | 24.0 | 1088.0 | 13.0 |  0.361 |
...
> **`yolo26n_512_s8_p4_tpie`** is the ESP32-P4 optimized variant (1.90× faster inference). It is produced by
> [`quantize_yolo26_coco_p4.ipynb`](../../examples/tutorial/how_to_quantize_model/quantize_yolo26/quantize_yolo26_coco_p4.ipynb)
> and includes: HardSiLU8 (Neural Morphing), TransposePIE, Nearest-Neighbor INT16 LUT, and TiledConv
> with activation fusion. ESP32-P4 only. Detections are **bit-exact** between the Python emulation
> and on-device inference when using raw RGB input.
