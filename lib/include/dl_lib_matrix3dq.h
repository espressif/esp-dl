...
void dl_matrix3dqq_conv_1x1_with_bn(dl_matrix3dq_t *out,
                                    dl_matrix3dq_t *in,
                                    dl_matrix3dq_t *f,
                                    dl_matrix3dq_t *scale,
                                    dl_matrix3dq_t *offset);

void dl_matrix3dqq_conv_1x1_with_bn_relu(dl_matrix3dq_t *out,
                                         dl_matrix3dq_t *in,
                                         dl_matrix3dq_t *f,
                                         dl_matrix3dq_t *scale,
                                         dl_matrix3dq_t *offset);
...
dl_matrix3dq_t *dl_matrix3dqq_conv_3x3_with_bn(dl_matrix3dq_t *in,
                                               dl_matrix3dq_t *f,
                                               dl_matrix3dq_t *scale,
                                               dl_matrix3dq_t *offset,
                                               int stride_x,
...
dl_matrix3dq_t *dl_matrix3dqq_depthwise_conv_3x3_with_bn(dl_matrix3dq_t *in,
                                                         dl_matrix3dq_t *f,
                                                         dl_matrix3dq_t *scale,
                                                         dl_matrix3dq_t *offset,
                                                         int stride_x,
...
dl_matrix3dq_t *dl_matrix3dqq_depthwise_conv_3x3s1_with_bn(dl_matrix3dq_t *in,
                                                           dl_matrix3dq_t *f,
                                                           dl_matrix3dq_t *scale,
                                                           dl_matrix3dq_t *offset,
                                                           dl_padding_type padding,
...
dl_matrix3dq_t *dl_matrix3dqq_mobilefaceblock_split(dl_matrix3dq_t *in,
                                                   ...
                                                   dl_matrix3dq_t *dw,
                                                   dl_matrix3dq_t *dw_bn_scale,
                                                   dl_matrix3dq_t *dw_bn_offset,
                                                   dl_matrix3dq_t *pw_linear_1,
                                                   dl_matrix3dq_t *pw_linear_2,
                                                   dl_matrix3dq_t *pw_linear_bn_scale,
                                                   dl_matrix3dq_t *pw_linear_bn_offset,
                                                   int pw_exponent,
                                                   int dw_exponent,
