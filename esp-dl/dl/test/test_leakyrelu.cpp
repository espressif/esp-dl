...
bool test_leakyrelu_s8(int exponent, int8_t activation_alpha, int offset0, int height, int width, int channel, bool inplace)
{
  if (!inplace)
  {
...
bool test_leakyrelu_s16(int exponent, int16_t activation_alpha, int offset0, int height, int width, int channel, bool inplace)
{
  if (!inplace)
  {
