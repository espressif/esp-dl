...
namespace dl
{
    typedef enum {
        ...
        MEMORY_RELAYOUT_INTERTWINE_32_32 = 1,       // Forming a 64-bit data by interposing 32-bit all-zero data with 32-bit valid data.
    ...
    public:
         ...
         */
        Constant(const T *element, const int exponent, const std::vector<int> shape, const bool dynamic_alloc = false, const dl::memory_relayout_type_t memory_relayout = dl::MEMORY_RELAYOUT_NO_CHANGE);
    ...
    public:
         ...
         *                 - 2D: [dilation_in_height, dilation_in_width]
         */
        Filter(const T *element, const int exponent, const std::vector<int> shape, const std::vector<int> dilation = {1, 1}, const bool dynamic_alloc = false);
    ...
    public:
         ...
         * @param shape     shape of element
         */
        Activation(const activation_type_t type, const T *element = NULL, const int exponent = 0, const std::vector<int> shape = {0}, const bool dynamic_alloc = false);
    };
} // namespace dl