...
namespace dl
{
    ...
    public:
         ...
         * 
         */
        Tensor(std::vector<int> shape, T* element=nullptr, int exponent=0, bool deep=true,  uint32_t caps=MALLOC_CAP_8BIT) : TensorBase()
        {
         ...
         * 
         */
        Tensor(std::vector<int> shape, const T* element, int exponent=0, bool deep=true,  uint32_t caps=MALLOC_CAP_8BIT) : TensorBase()
        {
            this->set_shape(shape);
            this->exponent = exponent;
            this->dtype = this->get_template_dtype();
         ...
         * If the dtype of input is different from this tensor, convert the element of input to the dtype of this tensor and copy them.
         * If this tensor is empty, malloc the element and copy input element.
         * 
         * @param input an input tensor 
         * @return 
         *         - true: same shape 
        ...
        //  * If the dtype of dest is different from this tensor, convert the element of this tensor to the dtype of dest and copy them.
        //  * 
