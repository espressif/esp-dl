 ...
 * @brief All macro here is for internal only. Once the project is compiled to static library, these macro is not effective.
 * @version 0.1
 * @date 2021-07-02
 * 
...
#define DL_S16_BUFFER_TYPE int64_t /*<! int32_t or int64_t. int32_t is twice as fast as int64_t in C/C++ implement. But int32_t may have value overflow. >*/
