...
class ReduceL2 : public ReduceBase {
public:
    using ReduceBase::ReduceBase;
    /**
     * @brief Destroy the ReduceL2 object.
     */
    ~ReduceL2() {}
    ...
    /**
     * @brief deserialize ReduceL2 module instance by node serialization information
     */
    static Module *deserialize(fbs::FbsModel *fbs_model, std::string node_name)
    {
        ...
        // Create module
        op = new ReduceL2(
            keepdims, axes_reduce_flag, "ReduceL2", node_name.c_str(), MODULE_INPLACE_CHANGED_BUFFER, quant_type);
        return op;
    }

    void print() { ReduceBase::print("ReduceL2"); }
};
} // namespace module
} // namespace dl
