...
class ReduceSumSquare : public ReduceBase {
public:
    using ReduceBase::ReduceBase;
    /**
     * @brief Destroy the ReduceSumSquare object.
     */
    ~ReduceSumSquare() {}
    ...
    /**
     * @brief deserialize ReduceSumSquare module instance by node serialization information
     */
    static Module *deserialize(fbs::FbsModel *fbs_model, std::string node_name)
    {
        ...
        // Create module
        op = new ReduceSumSquare(keepdims,
                                 axes_reduce_flag,
                                 "ReduceSumSquare",
                                 node_name.c_str(),
    ...
    void print() { ReduceBase::print("ReduceSumSquare"); }
};
} // namespace module
} // namespace dl
