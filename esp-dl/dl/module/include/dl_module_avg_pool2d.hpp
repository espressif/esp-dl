...
public:
    ...
    std::vector<std::vector<int>> get_output_shape(std::vector<std::vector<int>> &input_shapes)
    {
        ...
        output_shape[0] = (input_shape[0] + padding[0] + padding[1] - filter_shape[0]) / stride_y + 1;
        output_shape[1] = (input_shape[1] + padding[2] + padding[3] - filter_shape[1]) / stride_x + 1;
    ...
    void print() 
    {
        ESP_LOGI("AveragePool2D", "quant_type: %s.", quant_type_to_string(quant_type));
    }
};
} // namespace module
} // namespace dl
