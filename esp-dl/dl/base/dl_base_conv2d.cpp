...
namespace dl
{
    namespace base
    {
        ...
        void conv2d<int16_t, int16_t, DL_S16_BUFFER_TYPE>(void *args_ptr)
        {
            ...
            conv_operation_shell<int16_t, DL_S16_BUFFER_TYPE>(args, i_impl_func, i_impl_func_sp, c_impl_func, c_impl_func_sp, n_wise_func);
        }
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        inline void load_conv2d_11cn_s8(i_impl_func_s8_t &i_impl_func, i_impl_func_s8_t &i_impl_func_sp, const ArgsType<int8_t> &args)
        {
#if CONFIG_ESP32P4_BOOST
        ...
        inline void load_conv2d_33cn_s8(i_impl_func_s8_t &i_impl_func, i_impl_func_s8_t &i_impl_func_sp, const ArgsType<int8_t> &args)
        {
#if CONFIG_ESP32P4_BOOST
            if (args.output_channel % 16 == 0 && args.input_channel % 16 == 0 && !((unsigned)&args.input_element[0] & 15) && !((unsigned)&args.output_element[0] & 15)) {
                if (args.bias_element) {
        ...
        inline void load_conv2d_hwcn_s8(i_impl_func_s8_t &i_impl_func, i_impl_func_s8_t &i_impl_func_sp, const ArgsType<int8_t> &args)
        {
#if CONFIG_ESP32P4_BOOST
            if (args.output_channel % 16 == 0 && args.input_channel % 16 == 0 && !((unsigned)&args.input_element[0] & 15) && !((unsigned)&args.output_element[0] & 15)) {
                if (args.bias_element) {
        ...
        inline void load_conv2d_s8_per_tensor_c_func(c_impl_func_s8_t &c_impl_func, c_impl_func_s8_t &c_impl_func_sp, n_wise_func_s8_t &n_wise_func, const ArgsType<int8_t> &args)
        {
            if (args.filter_height == 1 && args.filter_width == 1) // Filter shape = [1, 1, C, N]
            {
        ...
        inline void load_conv2d_s8_per_channel_c_func(c_impl_func_s8_t &c_impl_func, c_impl_func_s8_t &c_impl_func_sp, n_wise_func_s8_t &n_wise_func, const ArgsType<int8_t> &args)
        {
            if (args.filter_height == 1 && args.filter_width == 1) // Filter shape = [1, 1, C, N]
            {
                c_impl_func_sp = conv2d_11cn<int8_t, int32_t>;
