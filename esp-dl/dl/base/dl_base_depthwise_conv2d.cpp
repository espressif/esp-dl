...
namespace dl
{
    namespace base
    {
                                                   ...
                                                   const ArgsType<int16_t> &args)
        {
            ...
            if (args.output_channel % 8 == 0 && args.input_channel % 8 == 0 && !((unsigned)&args.input_element[0] & 15) && !((unsigned)&args.output_element[0] & 15))
            {
        ...
        void depthwise_conv2d<int16_t, int16_t, DL_S16_BUFFER_TYPE>(void *args_ptr)
        {
            ...
            dwconv_operation_shell<int16_t, DL_S16_BUFFER_TYPE>(args, i_impl_func, i_impl_func_sp, c_impl_func, c_impl_func_sp, n_wise_func);
        }
        ...
        inline void load_depthwise_conv2d_33c1_s8(i_impl_func_s8_t &i_impl_func,i_impl_func_s8_t &i_impl_func_sp, const ArgsType<int8_t> &args)
        {
#if CONFIG_ESP32P4_BOOST
            if (args.output_channel % 16 == 0 && args.input_channel % 16 == 0 && !((unsigned)&args.input_element[0] & 15) && !((unsigned)&args.output_element[0] & 15)) {
                if (args.bias_element) {
                    switch (args.activation_type)
                    {
                    case Linear:
        ...
        inline void load_depthwise_conv2d_hwc1_s8(i_impl_func_s8_t &i_impl_func, i_impl_func_s8_t &i_impl_func_sp, const ArgsType<int8_t> &args)
        {
#if CONFIG_ESP32P4_BOOST
            if (args.output_channel % 16 == 0 && args.input_channel % 16 == 0 && !((unsigned)&args.input_element[0] & 15) && !((unsigned)&args.output_element[0] & 15)) {
                if (args.bias_element) {
        ...
        inline void load_depthwise_conv2d_s8_per_tensor_c_func(c_impl_func_s8_t &c_impl_func, c_impl_func_s8_t &c_impl_func_sp, n_wise_func_s8_t &n_wise_func, const ArgsType<int8_t> &args)
        {
            if (args.filter_height == 3 && args.filter_width == 3) // Filter shape = [3, 3, C, N]
            {
        ...
        inline void load_depthwise_conv2d_s8_per_channel_c_func(c_impl_func_s8_t &c_impl_func, c_impl_func_s8_t &c_impl_func_sp, n_wise_func_s8_t &n_wise_func, const ArgsType<int8_t> &args)
        {
            if (args.filter_height == 3 && args.filter_width == 3) // Filter shape = [3, 3, C, N]
            {
                c_impl_func_sp = depthwise_conv2d_33c1<int8_t, int32_t>;
        ...
        #endif
            dwconv_operation_shell<int8_t, int32_t>(args, i_impl_func, i_impl_func_sp, c_impl_func, c_impl_func_sp, n_wise_func);
        }
