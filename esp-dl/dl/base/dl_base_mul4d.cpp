    ...
    for (int iLoop = 0; iLoop < args.output_b; iLoop++) 
    {
        ...
        for (int jLoop = 0; jLoop < args.output_c; jLoop++) 
        {
            ...
            for (int kLoop = 0; kLoop < args.output_h; kLoop++) 
            {
                ...
                dl_esp32p4_s8_mul4d_bchw_w1_16_w2_16_simdmul(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w,   args.mul_shift);
#elif defined CONFIG_IDF_TARGET_ESP32S3
                dl_esp32s3_s8_mul4d_bchw_w1_16_w2_16_simdmul(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w,   args.mul_shift);
#endif
    ...
    for (int iLoop = 0; iLoop < args.output_b; iLoop++) 
    {
        ...
        for (int jLoop = 0; jLoop < args.output_c; jLoop++) 
        {
            ...
            for (int kLoop = 0; kLoop < args.output_h; kLoop++) 
            {
                ...
                feature_t *output_ptr_base = output_ptr + kLoop_output_offset;
#ifdef CONFIG_IDF_TARGET_ESP32P4
                dl_esp32p4_s8_mul4d_bchw_w1_16_w2_1_simdmul(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w,   args.mul_shift);
#elif defined CONFIG_IDF_TARGET_ESP32S3
                dl_esp32s3_s8_mul4d_bchw_w1_16_w2_1_simdmul(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w,   args.mul_shift);
#endif
            }
        }
    }
    ...
    for (int iLoop = 0; iLoop < args.output_b; iLoop++) 
    {
        ...
        for (int jLoop = 0; jLoop < args.output_c; jLoop++) 
        {
            ...
            for (int kLoop = 0; kLoop < args.output_h; kLoop++) 
            {
                ...
                feature_t *output_ptr_base = output_ptr + kLoop_output_offset;
#ifdef CONFIG_IDF_TARGET_ESP32P4
                dl_esp32p4_s8_mul4d_bchw_w1_1_w2_16_simdmul(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w,   args.mul_shift);
#elif defined CONFIG_IDF_TARGET_ESP32S3
                dl_esp32s3_s8_mul4d_bchw_w1_1_w2_16_simdmul(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w,   args.mul_shift);
#endif
    ...
    for (int iLoop = 0; iLoop < args.output_b; iLoop++) 
    {
        ...
        for (int jLoop = 0; jLoop < args.output_c; jLoop++) 
        {
            ...
            for (int kLoop = 0; kLoop < args.output_h; kLoop++) 
            {
                ...
                feature_t *output_ptr_base = output_ptr + kLoop_output_offset;
#ifdef CONFIG_IDF_TARGET_ESP32P4
                dl_esp32p4_s16_mul4d_bchw_w1_8_w2_8_simdmul(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w,   args.mul_shift);
#elif defined CONFIG_IDF_TARGET_ESP32S3
                dl_esp32s3_s16_mul4d_bchw_w1_8_w2_8_simdmul(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w,   args.mul_shift);
#endif
            }
        }
    }
    ...
    for (int iLoop = 0; iLoop < args.output_b; iLoop++) 
    {
        ...
        for (int jLoop = 0; jLoop < args.output_c; jLoop++) 
        {
            ...
            for (int kLoop = 0; kLoop < args.output_h; kLoop++) 
            {
                ...
                feature_t *output_ptr_base = output_ptr + kLoop_output_offset;
#ifdef CONFIG_IDF_TARGET_ESP32P4
                dl_esp32p4_s16_mul4d_bchw_w1_8_w2_1_simdmul(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w, args.mul_shift);
#elif defined CONFIG_IDF_TARGET_ESP32S3
                dl_esp32s3_s16_mul4d_bchw_w1_8_w2_1_simdmul(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w, args.mul_shift);
#endif
            }
        }
    }
    ...
    for (int iLoop = 0; iLoop < args.output_b; iLoop++) 
    {
        ...
        for (int jLoop = 0; jLoop < args.output_c; jLoop++) 
        {
            ...
            for (int kLoop = 0; kLoop < args.output_h; kLoop++) 
            {
                ...
                feature_t *output_ptr_base = output_ptr + kLoop_output_offset;
#ifdef CONFIG_IDF_TARGET_ESP32P4
                dl_esp32p4_s16_mul4d_bchw_w1_1_w2_8_simdmul(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w, args.mul_shift);
#elif defined CONFIG_IDF_TARGET_ESP32S3
                dl_esp32s3_s16_mul4d_bchw_w1_1_w2_8_simdmul(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w, args.mul_shift);
#endif
            }
        }
    }
            ...
            for (int jLoop = 0; jLoop < args.output_c; jLoop++) 
            {
                ...
                for (int kLoop = 0; kLoop < args.output_h; kLoop++) 
                {
                    ...
                    for (int lLoop = 0; lLoop < args.output_w; lLoop++) 
                    {
                        ...
                        // printf("input0=%d , input1=%d, output=%d, shift=%d\n", input0_ptr_base[lLoop * args.input0_w_same], input1_ptr_base[lLoop * args.input1_w_same], buffer, args.mul_shift);
                        printf("input0=%d , input1=%d\n", input0_ptr_base[lLoop * args.input0_w_same], input1_ptr_base[lLoop * args.input1_w_same]);
                    }
