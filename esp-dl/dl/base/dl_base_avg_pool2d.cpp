...
namespace dl
{
    namespace base
    {
        ...
        inline void avgpool2d_hwc1(buffer_t *buffer_ptr, feature_t *input_ptr, feature_t *output_ptr, PoolArgsType<feature_t> &args)
        {
            buffer_t input;
            ...
            {
                tool::truncate(output_ptr[output_c], round_half_even(buffer_ptr[output_c] * avg_pool_area_inv / DL_SCALE(args.output_exponent)));
                buffer_ptr[output_c] = 0;
            }
        }

        inline void load_avg_pool2d_hwc1_s16(i_impl_func_s16_t &i_impl_func, i_impl_func_s16_t &i_impl_func_sp, avg_pool_c_impl_func_s16_t &c_impl_func, PoolArgsType<int16_t> &args)
        {
#if CONFIG_TIE728_BOOST
            if (args.input_x_offset % 8 == 0 && args.output_x_offset % 8 == 0 && !((unsigned)&args.input_element[0] & 15) && !((unsigned)&args.output_element[0] & 15))
            {
            ...
            else
            {
                ...
                i_impl_func_sp = (args.filter_height == 2 && args.filter_width == 2) ? dl_tie728_s16_unaligned_avg_pool2d_22c1 : dl_tie728_s16_unaligned_avg_pool2d_hwc1;
            }
#else
        ...
        inline void load_avg_pool2d_hwc1_s8(i_impl_func_s8_t &i_impl_func, i_impl_func_s8_t &i_impl_func_sp, avg_pool_c_impl_func_s8_t &c_impl_func, PoolArgsType<int8_t> &args)
        {
#if CONFIG_ACCURATE_INFER
            c_impl_func = avgpool2d_hwc1<int8_t, float>;
#else
#if CONFIG_ESP32P4_BOOST
            if (args.input_x_offset % 16 == 0 && args.output_x_offset % 16 == 0 && !((unsigned)&args.input_element[0] & 15) && !((unsigned)&args.output_element[0] & 15))
            {
                i_impl_func = dl_esp32p4_s8_avg_pool2d_hwc1;
                i_impl_func_sp = (args.filter_height == 2 && args.filter_width == 2) ? dl_esp32p4_s8_avg_pool2d_22c1 : dl_esp32p4_s8_avg_pool2d_hwc1;
            }
            else
            {
                i_impl_func = dl_esp32p4_s8_unaligned_avg_pool2d_hwc1;
                i_impl_func_sp = (args.filter_height == 2 && args.filter_width == 2) ? dl_esp32p4_s8_unaligned_avg_pool2d_22c1 : dl_esp32p4_s8_unaligned_avg_pool2d_hwc1;
            }
#elif CONFIG_TIE728_BOOST
            if (args.input_x_offset % 16 == 0 && args.output_x_offset % 16 == 0 && !((unsigned)&args.input_element[0] & 15) && !((unsigned)&args.output_element[0] & 15))
            {
                i_impl_func = dl_tie728_s8_avg_pool2d_hwc1;
                i_impl_func_sp = (args.filter_height == 2 && args.filter_width == 2) ? dl_tie728_s8_avg_pool2d_22c1 : dl_tie728_s8_avg_pool2d_hwc1;
            }
            else
            {
                i_impl_func = dl_tie728_s8_unaligned_avg_pool2d_hwc1;
                i_impl_func_sp = (args.filter_height == 2 && args.filter_width == 2) ? dl_tie728_s8_unaligned_avg_pool2d_22c1 : dl_tie728_s8_unaligned_avg_pool2d_hwc1;
            }
#else
            c_impl_func = avgpool2d_hwc1<int8_t, float>;
#endif
