...
namespace dl
{
    namespace base
    {
         ...
         * NOTE: in tensorflow, when dilation > 1 the stride must be 1. Our api has no such limitation. But we didn't test this oppsite situation.
         * https://tensorflow.google.cn/api_docs/python/tf/nn/depthwise_conv2d
