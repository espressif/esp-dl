...
// inline void sub4d_11c(feature_t *output_ptr,
    ...
    for (int iLoop = 0; iLoop < args.output_b; iLoop++) 
    {
        ...
        for (int jLoop = 0; jLoop < args.output_c; jLoop++) 
        {
            ...
            for (int kLoop = 0; kLoop < args.output_h; kLoop++) 
            {
                ...
                dl_esp32p4_s8_sub4d_bchw_w1_16_w2_16_simdsub(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
#elif defined CONFIG_IDF_TARGET_ESP32S3
                dl_esp32s3_s8_sub4d_bchw_w1_16_w2_16_simdsub(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
#endif
/*
    ...
    for (int iLoop = 0; iLoop < args.output_b; iLoop++) 
    {
        ...
        for (int jLoop = 0; jLoop < args.output_c; jLoop++) 
        {
            ...
            for (int kLoop = 0; kLoop < args.output_h; kLoop++) 
            {
                ...
                feature_t *output_ptr_base = output_ptr + kLoop_output_offset;
#ifdef CONFIG_IDF_TARGET_ESP32P4
                dl_esp32p4_s8_sub4d_bchw_w1_16_w2_1_simdsub(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
#elif defined CONFIG_IDF_TARGET_ESP32S3
                dl_esp32s3_s8_sub4d_bchw_w1_16_w2_1_simdsub(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
#endif
            }
        }
    }
    ...
    for (int iLoop = 0; iLoop < args.output_b; iLoop++) 
    {
        ...
        for (int jLoop = 0; jLoop < args.output_c; jLoop++) 
        {
            ...
            for (int kLoop = 0; kLoop < args.output_h; kLoop++) 
            {
                ...
                feature_t *output_ptr_base = output_ptr + kLoop_output_offset;
#ifdef CONFIG_IDF_TARGET_ESP32P4
                dl_esp32p4_s8_sub4d_bchw_w1_1_w2_16_simdsub(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
#elif defined CONFIG_IDF_TARGET_ESP32S3
                dl_esp32s3_s8_sub4d_bchw_w1_1_w2_16_simdsub(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
#endif
    ...
    for (int iLoop = 0; iLoop < args.output_b; iLoop++) 
    {
        ...
        for (int jLoop = 0; jLoop < args.output_c; jLoop++) 
        {
            ...
            for (int kLoop = 0; kLoop < args.output_h; kLoop++) 
            {
                ...
                feature_t *output_ptr_base = output_ptr + kLoop_output_offset;
#ifdef CONFIG_IDF_TARGET_ESP32P4
                dl_esp32p4_s16_sub4d_bchw_w1_8_w2_8_simdsub(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
#elif defined CONFIG_IDF_TARGET_ESP32S3
                dl_esp32s3_s16_sub4d_bchw_w1_8_w2_8_simdsub(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
#endif
            }
        }
    }
    ...
    for (int iLoop = 0; iLoop < args.output_b; iLoop++) 
    {
        ...
        for (int jLoop = 0; jLoop < args.output_c; jLoop++) 
        {
            ...
            for (int kLoop = 0; kLoop < args.output_h; kLoop++) 
            {
                ...
                feature_t *output_ptr_base = output_ptr + kLoop_output_offset;
#ifdef CONFIG_IDF_TARGET_ESP32P4
                dl_esp32p4_s16_sub4d_bchw_w1_8_w2_1_simdsub(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
#elif defined CONFIG_IDF_TARGET_ESP32S3
                dl_esp32s3_s16_sub4d_bchw_w1_8_w2_1_simdsub(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
#endif
            }
        }
    }
    ...
    for (int iLoop = 0; iLoop < args.output_b; iLoop++) 
    {
        ...
        for (int jLoop = 0; jLoop < args.output_c; jLoop++) 
        {
            ...
            for (int kLoop = 0; kLoop < args.output_h; kLoop++) 
            {
                ...
                feature_t *output_ptr_base = output_ptr + kLoop_output_offset;
#ifdef CONFIG_IDF_TARGET_ESP32P4
                dl_esp32p4_s16_sub4d_bchw_w1_1_w2_8_simdsub(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
#elif defined CONFIG_IDF_TARGET_ESP32S3
                dl_esp32s3_s16_sub4d_bchw_w1_1_w2_8_simdsub(output_ptr_base, input0_ptr_base, input1_ptr_base, args.output_w);
#endif
            }
        }
    }
                               ...
                               const arithArgsType<int16_t> &args)
{
    ...
    {
        c_impl_func = sub4d_bchw_rescale<int16_t, int32_t>;
    }
#else
    c_impl_func = sub4d_bchw_rescale<int16_t, int32_t>;
#endif
                              ...
                              const arithArgsType<int8_t> &args)
{
    ...
    {
        c_impl_func = sub4d_bchw_rescale<int8_t, int16_t>;
    }
#else
    c_impl_func = sub4d_bchw_rescale<int8_t, int16_t>;
#endif
