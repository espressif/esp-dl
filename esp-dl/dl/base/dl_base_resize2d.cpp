...
namespace dl
{
    namespace base
    {
        ...
        inline void load_resized2d_nearest_2x2_c1_s8(resize_i_impl_func_s8_t &i_impl_func, resize_c_impl_func_s8_t &c_impl_func, const resizeArgsType<int8_t> &args)
        {
#if CONFIG_ESP32P4_BOOST
            if (args.input_channel % 16 == 0 && !((unsigned)&args.input_element[0] & 15) && !((unsigned)&args.output_element[0] & 15))
            {
