...
namespace dl
{
    namespace base
    {
        ...
        inline void max_pool2d_hwc1(buffer_t *buffer_ptr, feature_t *input_ptr, feature_t *output_ptr, PoolArgsType<feature_t> &args)
        {
        ...
        void max_pool2d<int16_t, int16_t, int64_t>(void *args_ptr)
        {
            ...
            if (args.input_x_offset % 8 == 0 && args.output_x_offset % 8 == 0 && !((unsigned)&args.input_element[0] & 15) && !((unsigned)&args.output_element[0] & 15))
            {
                ...
                i_impl_func_sp = (args.filter_height == 2 && args.filter_width == 2) ? dl_tie728_s16_max_pool2d_22c1 : dl_tie728_s16_max_pool2d_hwc1;
            }
            else
            {
                i_impl_func = dl_tie728_s16_unaligned_max_pool2d_hwc1;
                i_impl_func_sp = (args.filter_height == 2 && args.filter_width == 2) ? dl_tie728_s16_unaligned_max_pool2d_22c1 : dl_tie728_s16_unaligned_max_pool2d_hwc1;
            }
#else
        ...
        void max_pool2d<int8_t, int8_t, int32_t>(void *args_ptr)
        {
            ...
            if (args.input_x_offset % 16 == 0 && args.output_x_offset % 16 == 0 && !((unsigned)&args.input_element[0] & 15) && !((unsigned)&args.output_element[0] & 15))
            {
                ...
                i_impl_func_sp = (args.filter_height == 2 && args.filter_width == 2) ? dl_tie728_s8_max_pool2d_22c1 : dl_tie728_s8_max_pool2d_hwc1;
            }
            else
            {
                i_impl_func = dl_tie728_s8_unaligned_max_pool2d_hwc1;
                i_impl_func_sp = (args.filter_height == 2 && args.filter_width == 2) ? dl_tie728_s8_unaligned_max_pool2d_22c1 : dl_tie728_s8_unaligned_max_pool2d_hwc1;
            }
#else
