    ...
    namespace base
    {
        ...
        void prelu_11c(feature_t *output_ptr, feature_t *input_ptr, const ArgsType<feature_t> &args)
        {
            ...
            for (size_t output_c = 0; output_c < args.output_channel; output_c++)
            {
                ...
                {
                    temp = DL_RIGHT_SHIFT((buffer_t)output_ptr[output_c] * (buffer_t)alpha_ptr[output_c], args.activation_shift);
        ...
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        inline void load_prelu_11cn_s16(i_impl_acti_s16_t &i_impl_func, c_impl_acti_s16_t &c_impl_func, const ArgsType<int16_t> &args)
        {
        ...
        inline void load_prelu_11cn_s8(i_impl_acti_s8_t &i_impl_func, c_impl_acti_s8_t &c_impl_func, const ArgsType<int8_t> &args)
        {
