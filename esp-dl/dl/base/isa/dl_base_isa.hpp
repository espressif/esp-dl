...
void dl_esp32p4_s8_mul4d_bchw_w1_16_w2_16_simdmul(
    int8_t *output_ptr, int8_t *input0_ptr, int8_t *input1_ptr, int lenght, int shift);
void dl_esp32p4_s8_mul4d_bchw_w1_16_w2_1_simdmul(
    int8_t *output_ptr, int8_t *input0_ptr, int8_t *input1_ptr, int lenght, int shift);
void dl_esp32p4_s8_mul4d_bchw_w1_1_w2_16_simdmul(
    int8_t *output_ptr, int8_t *input0_ptr, int8_t *input1_ptr, int lenght, int shift);
void dl_esp32p4_s16_mul4d_bchw_w1_8_w2_8_simdmul(
    int16_t *output_ptr, int16_t *input0_ptr, int16_t *input1_ptr, int lenght, int shift);
void dl_esp32p4_s16_mul4d_bchw_w1_8_w2_1_simdmul(
    int16_t *output_ptr, int16_t *input0_ptr, int16_t *input1_ptr, int lenght, int shift);
void dl_esp32p4_s16_mul4d_bchw_w1_1_w2_8_simdmul(
    int16_t *output_ptr, int16_t *input0_ptr, int16_t *input1_ptr, int lenght, int shift);
