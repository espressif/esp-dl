...
struct FieldDef : public Definition {
    ...
    bool IsScalar() const { return ::flatbuffers::IsScalar(value.type.base_type); }
...
private:
    ...
    FLATBUFFERS_CHECKED_ERROR ParseAnyValue(Value &val,
                                            FieldDef *field,
    ...
    FLATBUFFERS_CHECKED_ERROR ParseNestedFlatbuffer(Value &val,
                                                    FieldDef *field,
                                                    size_t fieldn,
                                                    const StructDef *parent_struct_def);
    FLATBUFFERS_CHECKED_ERROR ParseMetaData(SymbolTable<Value> *attributes);
    FLATBUFFERS_CHECKED_ERROR TryTypedValue(
        const std::string *name, int dtoken, bool check, Value &e, BaseType req, bool *destmatch);
...
extern const char *GenTextFromTable(const Parser &parser,
                                    const void *table,
                                    const std::string &tablename,
                                    std::string *text);
