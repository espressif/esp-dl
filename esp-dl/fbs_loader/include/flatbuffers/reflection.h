...
std::string GetAnyValueS(reflection::BaseType type,
                         const uint8_t *data,
...
void SetString(const reflection::Schema &schema,
...
// If your FlatBuffer's root table is not the schema's root table, you should
// pass in your root_table type as well.
uint8_t *ResizeAnyVector(const reflection::Schema &schema,
                         uoffset_t newsize,
...
template <typename T>
void ResizeVector(const reflection::Schema &schema,
                  uoffset_t newsize,
                  T val,
                  const Vector<T> *vec,
                  std::vector<uint8_t> *flatbuf,
                  const reflection::Object *root_table = nullptr)
{
    ...
    auto newelems = ResizeAnyVector(schema,
                                    newsize,
