...
// Calculate the pixel data for a set of lines (with implied line size of 320). Pixels go in dest, line is the
// Y-coordinate of the first line to be calculated, linect is the amount of lines to calculate. Frame increases by one
// every time the entire image is displayed; this is used to go to the next frame of animation.
