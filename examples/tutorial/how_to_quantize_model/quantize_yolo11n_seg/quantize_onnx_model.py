...
def quant_yolo11n_seg(imgsz):
    ...
    ONNX_PATH = os.path.join(
        script_dir, "../../../../models/coco_seg/models/yolo11n-seg.onnx"
    )
    ESPDL_MODLE_PATH = os.path.join(
        script_dir,
        "../../../../models/coco_seg/models/p4/coco_seg_yolo11n_seg_s8_v1.espdl",
    )

    yolo11n_seg_caib_url = "https://dl.espressif.com/public/calib_yolo11n.zip"
    CALIB_DIR = "calib_yolo11n"
    urllib.request.urlretrieve(
        yolo11n_seg_caib_url, "calib_yolo11n.zip", reporthook=report_hook
    )
    ...
    quant_setting.equalization_setting.value_threshold = 0.2
    ...
    native_path = ESPDL_MODLE_PATH.replace(".espdl", ".native")
    exporter.export(file_path=native_path, graph=quant_ppq_graph)
    return quant_ppq_graph


if __name__ == "__main__":
    quant_yolo11n_seg(imgsz=640)
