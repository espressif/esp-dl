...
TEST_CASE("Test sw decode/encode", "[dl_image]")
{
    ...
    ESP_ERROR_CHECK(write_bmp(
        img, "/sdcard/sw_decode_rgb565_be_color_405x540.bmp", DL_IMAGE_CAP_RGB_SWAP | DL_IMAGE_CAP_RGB565_BIG_ENDIAN));
...
TEST_CASE("Test hw decode/encode", "[dl_image]")
{
    ...
    ESP_ERROR_CHECK(write_bmp(
        img, "/sdcard/hw_decode_rgb565_be_color_320x240.bmp", DL_IMAGE_CAP_RGB_SWAP | DL_IMAGE_CAP_RGB565_BIG_ENDIAN));
    // test_encode rgb565BE
    start = esp_timer_get_time();
